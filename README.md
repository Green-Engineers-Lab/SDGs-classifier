...
:arrow_right: **Model Link:** [SDG Classifier: A Fine-Tuned LUKE Model for Multi-Label SDG Classification](https://huggingface.co/GE-Lab/SDGs-classifier/blob/main/README.md)
